...
public class Project3 {
    ...
    public void keepNote() {
        ...
        titleField.sendKeys("Submit Time sheet");
        ...
        descField.sendKeys("Reminder to submit hours");
        ...
        WebElement savedTitle = wait.until(ExpectedConditions.visibilityOfElementLocated(
            AppiumBy.xpath("//android.widget.TextView[@resource-id=\"com.google.android.keep:id/index_note_title\" and @text=\"Submit Time sheet\"]")
        ));
        ...
        Assert.assertEquals(savedTitle.getText(), "Submit Time sheet", "Title verification failed!");
