...
user1_choice=input(user1_Name+" What you want to choose rock,paper or scissors? :")
user2_choice=input(user2_Name+" What you want to choose rock,paper or scissors? :")
