...
SELECT customer_id,order_date,MAX(purchase_amount) AS "Highest Purchase amount" FROM orders HAVING MAX(purchase_amount)  IN (2030, 3450, 5760, 6000) GROUP BY customer_id,order_date;
